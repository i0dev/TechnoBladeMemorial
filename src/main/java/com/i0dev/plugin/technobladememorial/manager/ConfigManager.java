...
public class ConfigManager extends AbstractManager {
    ...
    private File getConfigFile(String file) {
        ...
        TechnoBladeMemorial plugin = TechnoBladeMemorial.getPlugin();
        File configFile;
        if (file.contains("/")) {
    ...
    public void prepareFile(String filePath, String resource) {
        ...
        try {
            ...
            if (resource != null && !resource.isEmpty()) {
                this.copyResource(TechnoBladeMemorial.getPlugin().getResource(resource), file);
            }
    ...
    public String getPluginName() {
        return TechnoBladeMemorial.getPlugin().getDescription().getName();
    }
